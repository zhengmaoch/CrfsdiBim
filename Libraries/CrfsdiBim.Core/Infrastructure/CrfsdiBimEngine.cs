...
using CrfsdiBim.Core.Plugins;
using Microsoft.Extensions.Hosting;

namespace CrfsdiBim.Core.Infrastructure
{
    /// <summary>
    /// Represents CrfsdiBim engine
    /// </summary>
    public class CrfsdiBimEngine : IEngine
    {
        #region Properties
        ...
        /// </summary>
        /// <param name="nopConfig">Startup CrfsdiBim configuration parameters</param>
        /// <param name="services">Collection of service descriptors</param>
        /// <param name="typeFinder">Type finder</param>
        protected virtual IServiceProvider RegisterDependencies(CrfsdiBimConfig nopConfig, IServiceCollection services, ITypeFinder typeFinder)
        {
        ...
        public void Initialize(IServiceCollection services)
        {
            ...
            var crfsdiBimConfig = provider.GetRequiredService<CrfsdiBimConfig>();
            CommonHelper.BaseDirectory = hostingEnvironment.ContentRootPath;

            //initialize plugins
            //var mvcCoreBuilder = services.AddMvcCore();
            //PluginManager.Initialize(mvcCoreBuilder.PartManager, crfsdiBimConfig);
        }
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services, IConfigurationRoot configuration)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<ICrfsdiBimStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                //.Where(startup => PluginManager.FindPlugin(startup)?.Installed ?? true) //ignore not installed plugins
                .Select(startup => (ICrfsdiBimStartup)Activator.CreateInstance(startup))
            ...
            var nopConfig = services.BuildServiceProvider().GetService<CrfsdiBimConfig>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new CrfsdiBimException("Unknown dependency");
                        return service;
                    });
            ...
            throw new CrfsdiBimException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
